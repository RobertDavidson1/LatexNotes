...
\begin{examplebox}[Determine the image of the line $f(z) = \frac{1}{z} \quad \{z \in \mathbb{C}: \text{Re}(z) = 2\}$]
	...
	$$u = a(u^2 + v^2) \quad \Rightarrow \quad u = au^2 + av^2 \quad \Rightarrow \quad au^2 - u + av^2 = 0 \Rightarrow u^2 - \frac{1}{a} + v^2 = 0 $$
	\textbf{Completing the square in $u$:}
	$$\left(u^2 - \frac{1}{2a}\right)^2 - \frac{1}{4a^2} + av^2 = 0$$
	\textbf{Letting $a = 2$:}
	$$\left(u^2 - \frac{1}{4}\right)^2 - \frac{1}{16} + 4v^2 = 0$$
\end{examplebox}
