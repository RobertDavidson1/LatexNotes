    ...
    \begin{minipage}{0.49\textwidth}
        \begin{center}
            \begin{tikzpicture}
                ...
                \fill[custom_blue!20] (1,0) -- (1,1.5) arc (90:0:1.5) -- cycle;

                \draw[custom_blue, thick] (1,0) -- (1,1.5) node[midway, right] {$\pi/2$};
                \draw[custom_blue, thick] (1,0) -- (0,0) node[midway, below] {0};
                \draw[custom_blue, thick] (1,0) -- (1,1) node[midway, right] {$\pi/4$};

                \draw[custom_blue, thick] (1,0) -- (1,0.5) node[midway, right] {$\pi/8$};
                \draw[custom_blue, thick] (1,0) -- (1,1.25) node[midway, right] {$3\pi/8$};
                \draw[custom_blue, thick] (1,0) -- (1,1.75) node[midway, right] {$\pi/2$};
            \end{tikzpicture}
        \end{center}
    \end{minipage}
