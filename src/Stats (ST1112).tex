    ...
    \begin{minipage}{0.45\linewidth}
        ...
        \begin{tikzpicture}[scale = 0.9]
            \begin{axis}[
                ...
                samples=100,
                xlabel={$$},
                title={Heavy Tailed Data (Cauchy)},
                width=\linewidth,
                axis x line=bottom,
                axis y line=left,
                ytick=\empty,
...
If the data has a strongly skewed or otherwise non-normal distribution, applying a suitable transformation (e.g. $\log(x)$, $\sqrt{x}$) can help to make the data more symmetric and bell-shaped.\\ After the transformation, we can apply t-based or z-based methods can be applied more safely. 
\end{document}
