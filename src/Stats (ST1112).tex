...
We produce an interval estimate for population mean.
$$\bar{X} \pm Z_{\frac{\alpha}{2}} \frac{s}{\sqrt{n}}$$
\begin{examplebox}[ : NBA Salaries]
    ...
    \end{lstlisting}
    \begin{center}
        \includegraphics[scale=0.3]{images/nba_salaries.png}
    \end{center}
    ...
    \end{lstlisting}
    \begin{center}
        \includegraphics[scale=0.3]{images/nba_log_salaries.png}
    \end{center}
