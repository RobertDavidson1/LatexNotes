...
\end{definitionbox}
\begin{definitionbox}{Population standard deviation}{}
\end{definitionbox}
...
\begin{definitionbox}{Bessel's Correction}{}
\end{definitionbox}
...
\begin{definitionbox}{Unbiased Estimators}{}
    ...
    The sample standard deviation $s$ (using Bessel's correction, dividing by $n-1$) is an unbiased estimator of the population standard deviation $\sigma$.
\end{definitionbox}
\end{document}
