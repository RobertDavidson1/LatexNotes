...
\subsubsection{CI with large $\boldsymbol{n}$, $\boldsymbol{\sigma}$ unknown but replaced with $\boldsymbol{s}$}
...
\begin{examplebox}{Average student rent}{}
    A dataset of 103 students, of whom 71 pay rent, was used to estimate the average weekly rent $\mu$. \\
    Find the 95\% confidence interval for the population mean $\mu$ given: 
    \begin{itemize}
    ...
    Thus:
    $$546.239 \pm 1.96 \times \frac{187.862}{\sqrt{71}}$$
