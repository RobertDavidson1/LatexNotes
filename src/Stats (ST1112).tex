...
$$X \approx N\left(n\pi, \  n\pi(1- \pi)\right) \Rightarrow p = \frac{X}{n} \approx N\left(\pi, \frac{\pi(1 - \pi)}{n}\right)$$
Thus $p$ can be treated as approximately normally distributed for large $n$, centered at the true proportion $\pi$ with variance $\frac{\pi(1 - \pi)}{n}$.
\end{document}
