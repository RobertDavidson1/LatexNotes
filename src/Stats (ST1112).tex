...
\subsubsection{2.2 Standard Error}
...
\subsubsection*{2.4.2 Distribution Under $H_0$}
...
\subsection*{2.5 Example: Dishonest Casino?}
...
\section*{3. Test of Association (Two-Way Contingency Tables)}
...
\subsection*{3.2 Observed Counts}
...
\subsection*{3.3 Expected Counts (Under Independence)}
...
\subsection*{3.4 Chi-squared Test Statistic}
...
\subsection*{3.5 Degrees of Freedom}

\[
\nu = (r - 1)\times(c - 1).
\]

\subsection*{3.6 Decision and p-value}
...
\subsection*{3.7 Example: Driving License vs. Owning a Car}
...
\[
H_0: 
\text{Driver’s-license category is independent of owning a car.}
\quad
H_1: 
\text{There is an association (dependence).}
\]

\subsubsection*{3.7.1 Expected Counts}
...
\subsubsection*{3.7.2 Degrees of Freedom}

\[
(r - 1)(c - 1) = (3 - 1)(2 - 1) = 2.
\]

\subsubsection*{3.7.3 Decision}
...
\section*{4. Requirements and Tips}
...
\section*{5. Wrap-up and Key Takeaways}
...
Overall, chi-squared tests form a cornerstone of analyzing categorical data to see if observed frequencies match expected frequencies under certain assumptions (fairness, independence, etc.).
