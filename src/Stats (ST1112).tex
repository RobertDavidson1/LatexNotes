...
\subsubsection{CI with small $\boldsymbol{n}$, and $\boldsymbol{\sigma}$ unknown}
...
\begin{examplebox}{Unathorized Computer Acess}{}
    ...
    \end{itemize}
    $$n  = 19 \Rightarrow df = 18$$
    $$SE = \frac{s}{\sqrt{n}} = \frac{0.0074}{\sqrt{19}} \approx 0.0017$$
    For a 95\% confidence interval with $n-1 = 18$ degrees of freedom, the critical value is $t_{0.025, 18} \approx 2.101$.\\
    The confidence interval is given by:
    $$\bar{X} \pm t_{\alpha/2, df} \times SE = 0.29 \pm 2.101 \times 0.0017$$
    The resulting confidence interval is:
    $$(0.286, 0.294)$$
\end{examplebox}
