...
\begin{align*}
    \text{Compute the} \ \textbf{pooled variance}: &s_p^2 = \frac{(n_1 - 1)s_1^2 + (n_2 - 1)s_2^2}{n_1 + n_2 - 2}. \\
    \text{The} \ \textbf{Standard Error} \ is: &s_p \sqrt{\frac{1}{n_1} + \frac{1}{n_2}} \\
    \text{The test statistic follows a} \ \textbf{t-distribution} \ \text{with} \ n_1 + n_2 - 2 \ \text{degrees of freedom:}
\end{align*}
...
\subsubsection{Confidence Interval for $\mu_B - \mu_A$}
\[
