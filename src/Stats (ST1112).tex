...
\begin{examplebox}{Study time in NUI Galway}{}
    ...
    \textbf{Solution:}
        ...
        \begin{enumerate}
            ...
            \item \textbf{Identify the sampling distribution}\\
            We can use a normal approximation since $n \geq 30$, or more precisely, a t-distribution with $df = n - 1 = 101$ degrees of freedom.
            \item \textbf{Decide whether test statistic is rare or common}\\
        \end{enumerate}
