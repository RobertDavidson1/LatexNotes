...
Below is a detailed summary of the \textbf{Bootstrap and Permutation Test} material. It addresses how to compare two populations (in particular, their means) when the usual assumptions (e.g., normality) may be questionable, especially for small samples. These methods offer flexible, non-parametric (or distribution-free) alternatives.

\bigskip

\section{When Normality (or Other Assumptions) Is Questionable}
...
\section{Bootstrap CI for the Difference of Two Means}
...
\section{Permutation Test for Two-Sample Comparison}
...
\subsection{Example}
Suppose you have 6 observations from group 1 and 6 from group 2. The observed mean difference is 2.5. By randomly reassigning the 12 data points to “group 1” vs. “group 2” many times, we generate a \textbf{null distribution} of differences typically centered near 0. If only about 3\% of those permuted differences exceed 2.5 in magnitude, then the p-value is 0.03, providing evidence that the observed 2.5 difference is unlikely to arise under the null hypothesis of no difference.

\bigskip

\section{Comparison of Bootstrap CI vs. Permutation Test}
