...
\footnotesize \textbf{Example:} If $\alpha = 5$ and $i = 2$, then: \normalsize
$$\scriptsize
...
\end{itemize}
\footnotesize \textbf{Example:} Swapping rows 1 and 3: \normalsize
$$\footnotesize \scriptsize S = \begin{bmatrix}
    0 & 0 & 1 \\
    0 & 1 & 0 \\
    1 & 0 & 0
  \end{bmatrix}
...
\end{itemize}
\footnotesize\textbf{Example:} Adding 3 times row 1 to row 2: \normalsize
$$\footnotesize I_3 + 3E_{2,1} = \begin{bmatrix}
    1 & 0 & 0 \\
    3 & 1 & 0 \\
    0 & 0 & 1
