...
\end{lstlisting}
What the process does after it has finished calling the signal hander function depends on the situation. In the example above, it stopped sleeping. However if it had been making a blocking call, such as taking input from the keyboard, or reading from a pipe, it reutns to doing that.
% \section{Algorithms}
