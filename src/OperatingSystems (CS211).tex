...
The simplest algorithm, the first process that requests the CPU is the first to be executed.
\subsubsection{}
...
\begin{minipage}{0.49\textwidth}
    ...
    \end{tabularx}
\end{minipage}
Lets compute the average turnaround for both scenarios:
\begin{itemize}
    \item Scenario 1: $TAT = \frac{10 + 20 + 30}{3} = 20$
    \item Scenario 2: $TAT = \frac{19 + 29 + 30}{3} = 26$
\end{itemize}
