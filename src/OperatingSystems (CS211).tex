...
\begin{center}
    \begin{tabular}{|p{0.15\textwidth}|p{0.4\textwidth}|p{0.4\textwidth}|}
        \multicolumn{3}{|c|}{\textbf{Disadvantages}}                                                                                             \\
        \hline
         & Processes need each other's details before communication & Mailbox is owned by only one process; many can write but only one can read \\
        \hline
         & Only one link between processes                          & When owned by the OS, permissions must be granted for mailbox operations   \\
        \hline
         & Limited to two processes at a time                       &                                                                            \\
        \hline
    \end{tabular}
\end{center}
