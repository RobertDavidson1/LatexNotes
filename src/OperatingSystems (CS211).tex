...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{@{} l X X @{}}
        ...
        \midrule
        Implementation & Implemented by a thread library at compiler/library level above the OS kernel                                 & Created, managed and scheduled by the operating system kernel                                                                \\[2ex]
