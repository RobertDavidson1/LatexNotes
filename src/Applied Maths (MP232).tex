...
\begin{examplebox}[ : Solve the following initial value problem which governs the behavious of an RLC circuit]
  ...
  $$L\{Q\} = \frac{V_0 e^{-as}}{L(s+\frac{R}{2L})^2 + \frac{1}{C} - \frac{R^2}{4L^2}}$$
  Substituting $\alpha = \frac{R}{2L}$ and $\beta = \frac{1}{LC} - \frac{R^2}{4L^2}$ gives:
  $$L\{Q\} = \frac{V_0 e^{-as}}{L(s+\alpha)^2 + \beta}$$
\end{examplebox}
